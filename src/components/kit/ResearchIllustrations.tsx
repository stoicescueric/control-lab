...
/* Static teaching figures for the elective drag-aware launcher case study. These are diagrams,
  ...
  return (
    <MathFigure
      ...
      <svg
        viewBox="0 0 760 360"
        role="img"
        aria-label="Calibration lookup table: measured points, an overshooting natural spline, and a safe monotone interpolant."
        ...
        <rect
          ...
          y={sy(2480)}
          width={sx(100) - sx(60)}
          height={sy(shelfS) - sy(2480)}
          fill="rgba(255,111,156,0.12)"
        />
        <text
          x={sx(80)}
          y={sy(2520)}
