...
function ContributorCard({c, rank}: {c: Contributor; rank: number}) {
  return (
    <Link
      ...
      <h3 className="m-0 mt-4 text-base font-bold text-ink group-hover:text-accent-text">
        {c.login}
      </h3>
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-14 lg:py-16">
      <div className="mx-auto max-w-2xl text-center">
        <p className="m-0 mb-3 font-mono text-xs font-semibold text-accent-text uppercase">
          Open source
        </p>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          ...
          <Link
            ...
            to={`${repoUrl}/issues/new?template=content-correction.yml`}>
            Report a correction
          </Link>
        </div>
      </div>
