/* Tiny linear-algebra helpers for the Kalman / EKF demos.
   ...
   Ported verbatim from the legacy assets/js/linalg.js, now as an ES module. */
...
export const LA = { zeros, identity, clone, transpose, mul, add, sub, scale, matVec, inv };
export default LA;
